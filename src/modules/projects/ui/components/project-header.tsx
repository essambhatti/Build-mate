...
const ProjectHeader = ({projectId} : Props) => {
    ...
    return (<header className="p-2 flex justify-between items-center border-b">
        <DropdownMenu>
            ...
            >
            <Image src="/logo.svg" alt="Build-Mate" width={18} height={18}/>
            ...
            <DropdownMenuContent side="bottom" align="start">
                <DropdownMenuItem asChild>
                    <Link href="/">
                    <ChevronLeftIcon />
                    <span>Go to Dashboard</span></Link></DropdownMenuItem>
